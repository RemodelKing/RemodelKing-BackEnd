...
public class BusinessesProfileController : ControllerBase
{
    private readonly IUserService _userService;
    private readonly IMapper _mapper;

    public BusinessesProfileController(IUserService userService, IMapper mapper)
    {
    ...
    public async Task<IActionResult> GetAll()
    {
        ...
        var resources = _mapper.Map<IEnumerable<Business>, IEnumerable<BusinessProfileResource>>(users);
        return Ok(resources);
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        ...
        var resource = _mapper.Map<Business, BusinessProfileResource>(user);
